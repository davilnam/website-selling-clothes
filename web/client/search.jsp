    ...
    <body>
        ...
        <section class="shop">
            <div class="container">                
                <div class="row">
                    <div class="col">
                        <div class="alert alert-info" role="alert">
                            Từ khóa tìm kiếm: <strong>${requestScope.text}</strong>
                        </div>
                    </div>
                </div>


                <c:if test="${empty requestScope.listItemsPerPage}">
                ...
                <c:if test="${not empty requestScope.listItemsPerPage}">
                    <div class="row">
                        <div class="col">
                            <h4 class="mb-4">Kết quả:</h4>
